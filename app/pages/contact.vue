...
const submitForm = async () => {
  ...
  setTimeout(() => {
    ...
    Object.keys(form).forEach(key => form[key] = key === 'type' ? 'Demande d’information' : '');
  }, 5000);
};
  ...
  <div class="bg-light min-h-screen">
    ...
    <section ref="heroSection" class="relative py-20 md:py-32 bg-dark overflow-hidden flex items-center min-h-[400px]">
      ...
      <div class="absolute inset-0 z-0">
        <img src="/images/contact-bg.jpg" alt="Contact Lumen Agency" class="w-full h-full object-cover brightness-[0.5]" />
          ...
          <div class="relative inline-block">
            ...
            <h1 class="relative z-10 text-2xl sm:text-3xl md:text-5xl font-semibold text-white uppercase tracking-normal leading-[1.2] flex flex-col">
              <span class="block overflow-hidden py-1">
                <span class="inline-block opacity-0" :class="{ 'animate-title-reveal delay-100': heroVisible }">Donnons vie à</span>
              </span>
              <span class="block overflow-hidden py-1">
                <span class="inline-block opacity-0 text-primary font-bold" :class="{ 'animate-title-reveal delay-300': heroVisible }">vos projets</span>
              </span>
              <span class="block overflow-hidden py-1">
                <span class="inline-block opacity-0" :class="{ 'animate-title-reveal delay-500': heroVisible }">d'exception</span>
              </span>
            </h1>
          </div>
    ...
    <section class="py-20 md:py-32">
      <div class="container mx-auto px-4 md:px-8">
        <div class="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div class="w-full lg:w-1/3 space-y-12 reveal-on-scroll">
            ...
            <div class="space-y-8">
              <div class="group flex items-start gap-6">
                <div class="w-12 h-12 bg-white rounded-2xl shadow-sm border border-dark/5 flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <div>
                  <p class="text-[10px] font-bold text-dark/40 uppercase tracking-widest mb-1">Téléphone</p>
                  <a href="tel:+33123456789" class="text-dark font-medium hover:text-primary transition-colors">+33 (0)1 23 45 67 89</a>
                </div>
              </div>
              ...
              <div class="group flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="mailto:hello@lumen-agency.com" class="text-dark font-medium hover:text-primary transition-colors">hello@lumen-agency.com</a>
                </div>
              </div>
              ...
              <div class="group flex items-start gap-6">
                ...
                <div>
                  ...
                  <p class="text-dark font-medium">123 Avenue des Champs-Élysées, Paris, France</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Form Block -->
          <div class="w-full lg:w-2/3 bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-dark/5 border border-dark/5 reveal-on-scroll delay-300">
              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div class="relative group reveal-on-scroll delay-100">
                    <div class="absolute -inset-0.5 bg-gradient-to-r from-primary to-accent rounded-2xl blur opacity-0 group-focus-within:opacity-20 transition duration-500"></div>
                    <div class="relative">
                      <input 
                        v-model="form.name" 
                        id="name" 
                      ...
                      <div class="absolute right-6 top-1/2 -translate-y-1/2 opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primary/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="relative group reveal-on-scroll delay-500">
                  ...
                  <div class="relative">
                    ...
                    <label 
                      for="service" 
                      class="absolute left-6 transition-all duration-300 pointer-events-none"
                ...
                >
                  <div v-if="isDevis" class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    <div class="relative group">
                      <div class="absolute -inset-0.5 bg-gradient-to-r from-primary to-accent rounded-2xl blur opacity-0 group-focus-within:opacity-10 transition duration-500"></div>
                      <div class="relative">
                        <input 
                          v-model="form.date" 
                          id="date" 
                          ...
                          class="peer w-full px-6 pt-7 pb-3 bg-light/50 border border-dark/5 rounded-2xl focus:outline-none focus:border-primary/50 focus:bg-white transition-all outline-none"
                        />
                        <label for="date" class="absolute left-6 top-2 text-[10px] text-primary font-bold uppercase tracking-widest">Date prévue</label>
                      </div>
                    </div>
                    <div class="relative group">
                      <div class="absolute -inset-0.5 bg-gradient-to-r from-primary to-accent rounded-2xl blur opacity-0 group-focus-within:opacity-10 transition duration-500"></div>
                ...
                <div class="relative group reveal-on-scroll delay-700">
                  ...
                  <div class="relative">
                    <textarea 
                      ...
                      required 
                      placeholder=" "
                      class="peer w-full px-6 pt-7 pb-3 bg-light/50 border border-dark/5 rounded-2xl focus:outline-none focus:border-primary/50 focus:bg-white transition-all outline-none resize-none"
                    ></textarea>
                    <label 
                      for="message" 
                      class="absolute left-6 top-5 text-dark/40 text-xs font-bold uppercase tracking-widest transition-all duration-300 pointer-events-none peer-focus:top-2 peer-focus:text-[10px] peer-focus:text-primary peer-[:not(:placeholder-shown)]:top-2 peer-[:not(:placeholder-shown)]:text-[10px]"
                ...
                <div class="pt-6 flex justify-center">
                  ...
                  >
                    ...
                    <div class="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
            ...
            <!-- Success Message -->
            <div v-else class="h-full flex flex-col items-center justify-center text-center py-20 space-y-6">
              <div class="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center text-primary mb-4 animate-success-pop">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <div class="space-y-4 animate-title-reveal delay-200" style="animation-iteration-count: 1; opacity: 1;">
                <h3 class="text-2xl md:text-3xl font-bold text-dark uppercase tracking-tight">Message Envoyé !</h3>
                <p class="text-dark/60 max-w-sm mx-auto font-light leading-relaxed">
                  Merci de nous avoir contacté. Un expert de Lumen Agency reviendra vers vous dans les plus brefs délais.
                </p>
              </div>
              <button @click="isSubmitted = false" class="text-primary font-bold uppercase tracking-widest text-xs hover:underline decoration-2 underline-offset-8 pt-8 reveal-on-scroll active">Envoyer un autre message</button>
            </div>
          </div>
