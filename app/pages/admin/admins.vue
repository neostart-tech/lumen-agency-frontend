    ...
    <div v-else class="content-wrapper">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            <div
              ...
              <span class="text-xs ">{{ adminStore.admins.length }} Admin{{ adminStore.admins.length > 1 ? 's' : ''
                }}</span>
            </div>
        ...
        <div class="p-6">
          ...
          <vue3-datatable v-else :rows="adminStore.admins" :columns="allColumns" :search="searchQuery" :sortable="true"
            :sortColumn="'prenom'" :sortOrder="'asc'" :loading="adminStore.loading"
            skin="bh-table-hover bh-table-compact" class="custom-datatable" :pageSize="10"
            :totalRows="adminStore.admins.length" :noDataContent="'Aucun administrateur trouvé'"
      ...
      <div class="modal-content is-active">
        ...
        <form @submit.prevent="submitAdd" class="modal-form">
          ...
          <div class="info-banner">
            ...
            <p>Un mot de passe temporaire (8 caractères) sera généré automatiquement et envoyé par email à
              l'administrateur
              avec ses identifiants de connexion.</p>
          </div>
