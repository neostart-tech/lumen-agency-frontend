<template>
  <div class="services-ajouter-page">
    <AdminBreadcrumb :items="[{ label: 'Services', link: '/admin/services' }, { label: 'Nouveau service' }]" />
    ...
    <div class="content-card">
      <form @submit.prevent="saveService" class="admin-form">
        <div class="form-grid">
          <!-- Colonne Principale -->
          <div class="form-main">
        ...
        <div class="form-actions border-top">
          ...
          <button type="submit" class="btn-save" :disabled="serviceStore.loading">
            <component :is="IconSave" class="icon-sm" />
            {{ serviceStore.loading ? 'Enregistrement...' : 'Enregistrer le service' }}
          </button>
        </div>
      </form>
    </div>
...
const saveService = async () => {
  ...
  try {
    await serviceStore.store(formData)
    Swal.fire({
      icon: 'success',
    ...
    Swal.fire('Erreur', 'Impossible d\'ajouter le service.', 'error')
  }
}
</script>

<style scoped>
.services-ajouter-page {
  display: flex;
