        ...
        <div class="form-grid">
          ...
          <div class="form-main">
            <div class="form-group">
              ...
              <input type="text" v-model="form.titre" class="focus-blue" placeholder="Saisissez un titre accrocheur..."
                required />
            </div>
          ...
          <div class="form-sidebar bg-gray-50/50 p-6 rounded-2xl border border-gray-100 h-fit">
            ...
            <div class="form-group mb-4">
              ...
              <select v-model="form.categorie" required class="custom-select focus-blue text-sm">
                ...
                <option v-for="service in sortedServices" :key="service.id" :value="service.titre">
                  {{ service.titre }}
                </option>
              </select>
            </div>
            ...
            <div class="form-group mt-4">
              <label class="flex justify-between items-center">
                Image de Couverture
                <span
                  class="text-[9px] bg-secondary/10 text-secondary px-2 py-0.5 rounded-full  uppercase tracking-widest">Requis</span>
              </label>
            ...
            <div class="form-group mt-4 border-t border-gray-200 pt-5">
              ...
              <span class="text-[10px] text-gray-500 mb-2 block ">Ajoutez des images supplémentaires qui illustreront le
                corps de votre article.</span>

              <div class="gallery-grid">
                <!-- Previews -->
                <div v-for="(img, idx) in form.galerie" :key="idx" class="gallery-thumb">
                  <img :src="img.preview" alt="Gallery preview" />
                  <button type="button" class="btn-remove-thumb" @click="removeGalleryImg(idx)">
                    <component :is="IconClose" />
                  </button>
                </div>
...
const sortedServices = computed(() => {
  const services = [...serviceStore.services].sort((a, b) => a.titre.localeCompare(b.titre))
  return [...services, { id: 'autre', titre: 'AUTRE' }]
})
...
.custom-select.focus-blue:focus {
  ...
  box-shadow: 0 0 0 4px rgba(var(--color-secondary-rgb), 0.1) !important;
}
...
.gallery-add-btn.edit-mode:hover {
  border-color: var(--color-secondary);
