      ...
      <form @submit.prevent="saveBlog" class="admin-form">
        <div class="form-grid">
          ...
          <div class="form-sidebar bg-gray-50/50 p-6 rounded-2xl border border-gray-100 h-fit">
            <h3 class="text-sm  text-gray-800 uppercase tracking-widest mb-6 border-b border-gray-200 pb-3">Détails &
              Médias</h3>
            ...
            <div class="form-group mt-4">
              <label class="flex justify-between items-center">
                Image de Couverture
                <span
                  class="text-[9px] bg-primary/10 text-primary px-2 py-0.5 rounded-full  uppercase tracking-widest">Requis</span>
              </label>
