<template>
  <div class="blogs-page min-h-screen bg-[#f8fafc] p-6 space-y-6">
    ...
    <div v-if="blogStore.loading && blogStore.blogs.length === 0"
      class="bg-white rounded-2xl h-96 animate-pulse border border-gray-200"></div>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="flex flex-wrap items-center gap-4 px-6 py-4 border-b border-gray-50 bg-[#fafafa]/50">
          <div class="relative w-full sm:w-64">
            ...
            <input v-model="searchQuery" type="text" placeholder="Rechercher par titre, contenu..."
          ...
          <div class="relative" ref="dropdownRef">
            <button @click="isDropdownOpen = !isDropdownOpen"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
              </svg>
              Colonnes
            ...
            <transition name="dropdown">
              <div v-if="isDropdownOpen"
                ...
                <div class="py-1 max-h-40 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200">
        ...
        <!-- TABLE -->
        <div class="p-6">
          <vue3-datatable :rows="blogs" :columns="visibleColumns" :search="searchQuery" :sortable="true"
            :loading="blogStore.loading" skin="bh-table-hover bh-table-compact" class="custom-datatable" :pageSize="10"
            :totalRows="blogs.length" :noDataContent="'Aucun article trouvé'"
            ...
            <template #categorie="data">
              <span
                class="px-3 py-1 bg-gray-100 text-gray-700 text-[11px]  rounded-md border border-gray-200 uppercase tracking-wide">
            ...
            <template #contenu="data">
              <span class="text-sm text-gray-500 truncate max-w-[300px] inline-block" :title="data.value.contenu">{{
                data.value.contenu }}</span>
            </template>
