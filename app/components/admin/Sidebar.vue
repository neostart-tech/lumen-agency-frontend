  ...
  <aside class="admin-sidebar" :class="{ 'is-mobile-open': isOpen, 'is-collapsed': isCollapsed }">
    <div class="sidebar-header">
      <div v-if="!isCollapsed" class="logo-area">
        <img src="/images/logo-fond-blanc.png" alt="Logo Lumen Agency" class="sidebar-logo" />
      </div>
      <div v-else><img src="/images/logo-fond-blanc.png" alt="Logo Lumen Agency" class="sidebar-logo" />
      </div>
    ...
    <nav class="sidebar-nav">
      <div class="nav-section">
        ...
        <NuxtLink to="/admin/messages" class="nav-link" active-class="is-active" title="Messages">
          ...
          <span v-if="!isCollapsed && messageStore.unreadCount > 0" class="badge-count">{{ messageStore.unreadCount
          }}</span>
        </NuxtLink>
        ...
        <NuxtLink v-if="auth.user?.role === 'superadmin'" to="/admin/admins" class="nav-link superadmin-link"
          active-class="is-active" title="Administrateurs">
          <div class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-section">
        ...
        <!-- Services -->
        <div class="nav-dropdown" :class="{ 'is-open': activeDropdown === 'services' }">
          <button class="nav-link dropdown-toggle" @click="toggleDropdown('services')" title="Services">
            <div class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span v-if="!isCollapsed" class="nav-label">Services</span>
            <svg v-if="!isCollapsed" class="chevron" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
              <polyline points="6 9 12 15 18 9"></polyline>
            </svg>
          </button>
          <div v-show="activeDropdown === 'services' && !isCollapsed" class="dropdown-content">
            <NuxtLink to="/admin/services" class="dropdown-link" active-class="is-sub-active">Liste des services
            </NuxtLink>
            <NuxtLink to="/admin/services/ajouter" class="dropdown-link" active-class="is-sub-active">Ajouter un service
            </NuxtLink>
          </div>
        </div>
        ...
        <div class="nav-dropdown" :class="{ 'is-open': activeDropdown === 'blogs' }">
          ...
          <div v-show="activeDropdown === 'blogs' && !isCollapsed" class="dropdown-content">
            ...
            <NuxtLink to="/admin/blogs/ajouter" class="dropdown-link" active-class="is-sub-active">Ajouter un blog
            </NuxtLink>
          </div>
        </div>

        <NuxtLink to="/admin/contacts" class="nav-link" active-class="is-active" title="Nos Contacts">
          <div class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span v-if="!isCollapsed" class="nav-label">Nos Contacts</span>
        </NuxtLink>
