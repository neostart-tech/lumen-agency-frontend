  ...
  <header class="fixed top-0 left-0 w-full z-50 bg-light/90 backdrop-blur-md border-b border-dark/5">
    <div class="container mx-auto px-4 md:px-8">
      <div class="flex items-center justify-between h-20">
        ...
        >
          <span class="w-6 h-0.5 bg-dark transition-all duration-300" :class="{ 'rotate-45 translate-y-2': isMenuOpen }"></span>
    ...
    >
      <div v-if="isMenuOpen" class="md:hidden absolute top-20 left-0 w-full bg-white border-b border-dark/5 shadow-xl py-8 px-4">
